  ...
  return (
    <section className="flex h-full justify-center items-center bg-gray-100">
      <div className="flex flex-col gap-2 w-96 m-2 p-6 bg-white rounded-lg shadow-lg">
        <h2 className="mx-auto text-xl">Welcome to School Management</h2>
        <img src="logo512.png" className="w-32 mx-auto my-8" alt="School Management" />
        <button
          onClick={() => handleSignin(signInWithGoogle)}
          className="flex justify-center gap-2 bg-blue-600 text-white hover:shadow-lg rounded-full p-2"
        >
        ...
        <button
          ...
          className="flex justify-center gap-2 bg-gray-600 text-white hover:shadow-lg rounded-full p-2"
        >
          <svg role="img" className="w-6 h-6 fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <title>GitHub</title>
